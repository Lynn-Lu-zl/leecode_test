...
public class 篮球比赛分组 {
    ...
    public static void main(String[] args) {
        ...
        //篮球比赛分组，因为题目确定了是10个队员分两队，也就是每个队5个人，我们可以先固定前四个队员，接着遍历剩下的六名选择其中一个队员为一队，剩下5人为二队，计算两队战力并求差。然后固定前三个队员+第五位队员，接着遍历后面的五位队员选择其中一个队员为一队，剩下5人为二队，计算两队战力并求差。。。。最后求差值的最小值
        Scanner sc = new Scanner(System.in);
        int[] ints = new int[10];
        int count = 0;
        for(int i=0;i<10;i++){
